...
This document provides a comprehensive overview of all features available in the ReUseIt mobile application.
...
- **Activity History:** Track past actions, posts, and event participation
...
- **Contact Information:** Phone numbers and websites for facilities
...
- **Detailed Descriptions:** Provide comprehensive item information
...
- **Sort Options:** Order by date, relevance, or popularity
...
- **Action-Based Points:** Earn points for various activities
  ...
  - Event organization: 50 points
- **Daily Bonuses:** Extra points for consecutive daily logins
...
- **Milestone Badges:** Unlock at specific point thresholds
  ...
  - Gold Badge: 1,000 points
  - Platinum Badge: 5,000 points
- **Activity Badges:** For specific accomplishments
  - First Post
  - Event Organizer
  - Community Helper
  - Recycling Expert
...
- **Time Periods:** Daily, weekly, monthly, and all-time leaders
...
- **Impact Metrics:** Estimated environmental impact of your actions
...
- **User Reviews:** (Planned) Community ratings and feedback
...
- **Frequency Tracking:** Monitor how often you recycle
...
- **Achievement Unlocks:** Celebrate when earning new badges
...
- **Channel Selection:** Pick between push, email, or in-app
...
- **Data Export:** Download your personal data anytime
...
- **Anonymous Mode:** (Planned) Browse without tracking
...
- **Recycling Challenges:** Time-limited community challenges
- **Virtual Rewards:** Redeem points for eco-friendly products
- **Educational Videos:** Video tutorials and guides
- **Carbon Footprint Tracker:** Calculate and reduce your carbon impact
